...
""")
print(f"\033[92m╔{'═' * 72}╗")
print(f"\033[92m║\033[48;5;1m\033[97m  Design: Kunfayz weh{' ' * 50} \033[0m\033[92m║")
print(f"\033[92m║\033[48;5;1m\033[97m  Garis keras pembela Palestina{' ' * 40} \033[0m\033[92m║")
print(f"\033[92m╚{'═' * 72}╝")
