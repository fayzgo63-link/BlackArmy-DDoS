...
""")
print(f"\033[92m╔{'═' * 65}╗")
print(f"\033[92m║\033[48;5;1m\033[97m  Design: Kunfayz namaku{' ' * 40} \033[0m\033[92m║")
print(f"\033[92m║\033[48;5;1m\033[97m  Black Army Cyber grupe{' ' * 40} \033[0m\033[92m║")
print(f"\033[92m╚{'═' * 65}╝")
